    ...
    return (
        <nav className="fixed top-[2vmin] w-full z-50 shadow-md">
            <div className="h-[8vh] bg-[#2B4B7E] flex items-center justify-between px-6 md:px-16">
                ...
                <div className="hidden md:flex gap-6 text-[2vmin] text-white">
                    <NavLink 
                        to="/instructions" 
                        className={({ isActive }) => 
                ...
                <div className="flex items-center gap-4">
                    {isLoggedIn ? (
                        <button 
                            ...
                            className="w-[15vmin] p-[1vmin] text-[2vmin] text-center rounded-md text-white bg-gradient-to-r from-[#FF9A9A] to-[#DE0000] hover:from-[#FF8A8A] hover:to-[#CE0000]"
                        >
                            LOG OUT
                        </button>
                    ) : (
